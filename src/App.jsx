...
export default function App() {
  ...
  if (!playerData) return <div style={{background:"#050510",height:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}><div style={{color:"#7DF9FF",fontFamily:"'Space Mono',monospace",fontSize:14,letterSpacing:2}}>LOADING...</div></div>;
